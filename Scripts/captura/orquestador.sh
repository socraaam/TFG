...
echo "Iniciando captura: ${TIPOS_DNS[*]}"
...
for TIPO in "${TIPOS_DNS[@]}"; do
    ...
    echo "Ejecuta en cliente: ./cliente_dns.sh $TIPO"
    tiempo=0
...
echo "Completo. Próximo paso: python pcap_a_dataset.py --from-capturas --label 1"
